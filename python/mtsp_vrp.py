...
def solve_mtsp_vrp(start_positions, end_positions, weights, timeout):
    ...
    result = _solve_mtsp_vrp(A, N, start_positions, end_positions, weights, timeout, number_of_threads, byref(lb), byref(ub), pathsBuffer, offsets)
    if result < 0:
